...
COLS = {
    "color0": "#292D3E",  # panel background
    "color1": "#434758",  # background for current screen tab
    "color2": "#D0D0D0",  # font color for group names
    "color3": "#F07178",  # background color for layout widget
    "color4": "#000000",  # background for other screen tabs
    "color5": "#AD69AF",  # dark green gradiant for other screen tabs
    "color6": "#C3E88D",  # background color for network widget
    "color7": "#C792EA",  # background color for pacman widget
    "color8": "#9CC4FF",  # background color for cmus widget
    "color9": "#000000",  # background color for clock widget
    "color10": "#434758",  # background color for systray widget
    "dark_0": "#1d2021",
    "dark_1": "#282828",
    "dark_2": "#32302f",
    "dark_3": "#3c3836",
...
FONT_PARAMS = {"font": FONT, "fontsize": FONTSIZE, "foreground": FOREGROUND}
